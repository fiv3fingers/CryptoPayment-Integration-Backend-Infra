...
class V2_FACTORY_ADDRESS(str, Enum):
...
class V2_ROUTER_ADDRESS(str, Enum):
...
class V3_FACTORY_ADDRESS(str, Enum):
...
class V3_ROUTER_ADDRESS(str, Enum):
    ...
    BNBCHAIN = "0x5Dc88340E1c5c6366864Ee415d6034cadd1A9897"
...
CONTRACT_ADDRESS: Dict[ChainId, Tuple[V2_FACTORY_ADDRESS, V2_ROUTER_ADDRESS, V3_FACTORY_ADDRESS, V3_ROUTER_ADDRESS]] = {
    ChainId.ETH:          (V2_FACTORY_ADDRESS.MAINNET,     V2_ROUTER_ADDRESS.MAINNET,      V3_FACTORY_ADDRESS.MAINNET,      V3_ROUTER_ADDRESS.MAINNET),
    ChainId.SEPOLIA:      (V2_FACTORY_ADDRESS.SEPOLIA,     V2_ROUTER_ADDRESS.SEPOLIA,      V3_FACTORY_ADDRESS.SEPOLIA,      V3_ROUTER_ADDRESS.SEPOLIA),
    ChainId.ARBITRUM:     (V2_FACTORY_ADDRESS.ARBITRUM,    V2_ROUTER_ADDRESS.ARBITRUM,     V3_FACTORY_ADDRESS.ARBITRUM,     V3_ROUTER_ADDRESS.ARBITRUM),
    ChainId.AVALANCHE:    (V2_FACTORY_ADDRESS.AVALANCHE,   V2_ROUTER_ADDRESS.AVALANCHE,    V3_FACTORY_ADDRESS.AVALANCHE,    V3_ROUTER_ADDRESS.AVALANCHE),
    ChainId.BSC:          (V2_FACTORY_ADDRESS.BNBCHAIN,    V2_ROUTER_ADDRESS.BNBCHAIN,     V3_FACTORY_ADDRESS.BNBCHAIN,     V3_ROUTER_ADDRESS.BNBCHAIN),
    ChainId.BASE:         (V2_FACTORY_ADDRESS.BASE,        V2_ROUTER_ADDRESS.BASE,         V3_FACTORY_ADDRESS.BASE,         V3_ROUTER_ADDRESS.BASE),
    ChainId.OPTIMISM:     (V2_FACTORY_ADDRESS.OPTIMISM,    V2_ROUTER_ADDRESS.OPTIMISM,     V3_FACTORY_ADDRESS.OPTIMISM,     V3_ROUTER_ADDRESS.OPTIMISM),
    ChainId.POLYGON:      (V2_FACTORY_ADDRESS.POLYGON,     V2_ROUTER_ADDRESS.POLYGON,      V3_FACTORY_ADDRESS.POLYGON,      V3_ROUTER_ADDRESS.POLYGON),
    ChainId.BLAST:        (V2_FACTORY_ADDRESS.BLAST,       V2_ROUTER_ADDRESS.BLAST,        V3_FACTORY_ADDRESS.BLAST,        V3_ROUTER_ADDRESS.BLAST)
}
