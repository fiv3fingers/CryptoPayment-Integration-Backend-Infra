...
class CoinGeckoAPI:
    ...
    def _get_coingecko_id(self, currency: Union[CurrencyBase, Currency]) -> Union[str, None]:
        # TODO: Add cashing mechanism
    ...
    def get_prices(
        ...
        id_currencies = list({
            (id, currency) for currency in currencies 
    ...
    def get_token_info(self, currency: Union[Currency, CurrencyBase]) -> Optional[Currency]:
